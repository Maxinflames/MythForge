        ...
        <div class="container">
            ...
            <div class="form-group text-center">
                ...
                <div class="form-group text-center">
                    ...
                    <a class="btn btn-primary" href="/loot-groups/{{$loot_group->loot_group_id}}/loot-table/add">Add Item from Loot Table</a>
                </div>
                <table class="table table-striped">
                    <!-- Table column headers -->
                    <tr>
                    ...
                    @foreach ($loot_group_items as $loot_group_item)
                        <tr>
                            ...
                            <td class="text-center width-5">
                                <form action="/loot-groups/{{$loot_group->loot_group_id}}/items/{{$loot_group_item->loot_group_item_id}}/remove" method="POST">
