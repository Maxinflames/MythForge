                        ...
                        <div class="panel-body">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <textarea rows="4" id="user_description" readonly="true" type="text" class="form-control"
                                            name="user_description">{{ $user->user_description }}</textarea>
                                    </div>
                                </div>
                            </form>
                        </div>
